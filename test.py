...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='D:/Project/yolov5/runs/train/20210201jf1/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='20200202jf', help='save to project/name')
